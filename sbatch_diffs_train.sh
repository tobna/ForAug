...
srun -K \
  ...
  python3 make_diffs.py -n 300 -id $SLURM_ARRAY_TASK_ID -w 16 -in /ds-sds/images/imagenet -fn /fscratch/nauen/INSegment_v1_f1 -s train -o /netscratch/nauen/datasets/INDiffs